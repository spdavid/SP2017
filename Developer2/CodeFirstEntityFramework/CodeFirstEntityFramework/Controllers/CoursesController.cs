...
namespace CodeFirstEntityFramework.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            var courses = db.Courses.Include(c => c.School);
        ...
        public ActionResult Create([Bind(Include = "Id,Name,SchoolId")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,SchoolId")] Course course)
        {
            if (ModelState.IsValid)
            {
