...
import { ICallsecuredfunctionProps } from './components/ICallsecuredfunctionProps';
...
export default class CallsecuredfunctionWebPart extends BaseClientSideWebPart<ICallsecuredfunctionWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<ICallsecuredfunctionProps > = React.createElement(
      Callsecuredfunction,
      {
