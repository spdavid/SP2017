...
import StatusIndicator, { IStatusIndicatorProps } from './components/StatusIndicator';
...
export default class StatusIndicatorFieldCustomizer
  ...
  public onRenderCell(event: IFieldCustomizerCellEventParameters): void {
    ...
    const statusIndicator: React.ReactElement<{}> =
      React.createElement(StatusIndicator, { text } as IStatusIndicatorProps);

    ReactDOM.render(statusIndicator, event.domElement);
  }
